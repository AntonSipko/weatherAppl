...
test("first test for nextstep", () => {
    ...
    expect(lifeMatrix.nextStep()).toEqual(expectedMatrix)
})
test("second test for nextstep", () => {
    const matrix: number[][] = [
        [0, 1, 1,],
        [1, 0, 1,],
        [0, 0, 1,]
